...
void main() {
  group('expandManifestVars', () {
    test('expands a known variable', () {
      expect(
        expandManifestVars(r'${embedder_root}/lib', {'embedder_root': '/a/b'}),
        '/a/b/lib',
      );
    });
    ...
    test('expands multiple variables in one string', () {
      expect(
        expandManifestVars(r'${embedder_root}/${runnable}', {
          'embedder_root': '/emb',
    ...
    test('leaves unknown tokens verbatim', () {
      expect(
        expandManifestVars(r'${unknown}/lib', {'embedder_root': '/a'}),
        r'${unknown}/lib',
      );
    });
    ...
    test('expands app_root when present', () {
      expect(
        expandManifestVars(r'${app_root}/assets', {'app_root': '/myapp'}),
        '/myapp/assets',
      );
    });
    ...
    test('expands runnable with multi-backend suffix', () {
      ...
      expect(
        expandManifestVars(r'${runnable}/lib/libfoo.so', {
